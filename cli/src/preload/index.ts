...
const api: ForgeApi = {
  ...
  getDeepseekBalance: () => ipcRenderer.invoke('forge:getDeepseekBalance'),
  getDeepseekApiKeyStatus: () => ipcRenderer.invoke('forge:getDeepseekApiKeyStatus'),
  saveDeepseekApiKey: (key) => ipcRenderer.invoke('forge:saveDeepseekApiKey', key),
  ...
  explainEdit: (sample) => ipcRenderer.invoke('forge:explainEdit', sample),
  summarizeActivityGroup: (sample) => ipcRenderer.invoke('forge:summarizeActivityGroup', sample),

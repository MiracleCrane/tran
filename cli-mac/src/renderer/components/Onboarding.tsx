  ...
  return (
    <div className="flex h-full items-center justify-center bg-transparent px-6">
      <div className="w-full max-w-lg rounded-2xl border border-border-subtle bg-bg-panel p-8 shadow-2xl">
        ...
        {isMac ? (
          <div className="mb-4 rounded-lg border border-accent bg-accent/15 px-3 py-2 text-sm text-zinc-100">
            macOS（原生）
          </div>
        ) : (
        ...
        <div className="mb-4 flex gap-2">
          <input
            ...
            placeholder={backend === 'wsl' ? '/home/user/project' : isMac ? '/Users/you/project' : 'C:\\Projects\\path'}
